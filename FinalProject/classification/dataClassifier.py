...
def analysis(classifier, guesses, testLabels, testData, rawTestData, printImage):
  ...
  Use the print(Image(<list of pixels>) function to visualize features.
  ...
  - print(Image is a method to visualize the features 
...
class Imageprinter:
    ...
    def printImage(self, pixels):
      """
      print(s a Datum object that contains all pixels in the 
...
def readCommand( argv ):
  ...
  parser.add_option('-k', '--smoothing', help=default("Smoothing parameter (ignored when using --autotune)"), type="float", default=0.077)
